...
- Sections: how it works (3 real steps: add products → plan the rhythm → check off AM/PM), expiry-watching shelf, scheduling flexibility ("Kwas co trzy dni? Ogarnięte."), a vertical-video strip (9:16 TikTok-style clips — design the slot with tasteful placeholders, content comes later), final waitlist CTA.
