...
export const INGREDIENT_COMPATIBILITY: IngredientCompatibility[] = [
  {
    ...
    keywords: ['retinol', 'retinoid', 'retin-a', 'tretinoin', 'adapalene', 'differin', 'retinal', 'bakuchiol'],
  ...
  {
    name: 'Vitamin C',
    keywords: ['vitamin c', 'ascorbic acid', 'l-ascorbic', 'ascorbyl', 'tetrahexyldecyl ascorbate', 'ethylated ascorbic'],
...
export const CONFLICT_RULES: ConflictRule[] = [
  {
    ...
    reason: 'Both are potent actives that can cause irritation, redness, and peeling when used together. Retinol works best at a higher pH while Vitamin C needs a low pH. Use Vitamin C in the morning and Retinol at night.'
  },
  {
    ingredientA: 'Retinol / Retinoids',
    ...
    reason: 'Combining retinol with AHA exfoliants significantly increases the risk of irritation, dryness, and compromised skin barrier. Use on alternate nights or different days.'
  },
  {
    ingredientA: 'Retinol / Retinoids',
    ...
    reason: 'Both increase skin sensitivity and cell turnover. Using together can lead to excessive dryness, peeling, and irritation. Alternate their use on different nights.'
  },
  {
    ingredientA: 'Retinol / Retinoids',
    ...
    reason: 'Benzoyl peroxide can oxidize and deactivate retinol, making both less effective. They also cause significant dryness together. Use at different times of day.'
  },
  {
    ...
    reason: 'Both are acidic and can over-exfoliate the skin when layered. This may cause redness and sensitivity. Apply Vitamin C in the morning and AHA in the evening.'
  },
  {
    ingredientA: 'Vitamin C',
    ingredientB: 'BHA (Salicylic Acid)',
    ...
    reason: 'Layering these acids can disrupt pH levels and reduce effectiveness of both. Use at different times — Vitamin C in the AM, BHA in the PM.'
  },
  {
    ingredientA: 'Vitamin C',
    ingredientB: 'Benzoyl Peroxide',
    ...
    reason: 'Benzoyl peroxide oxidizes Vitamin C, rendering it ineffective. Never apply them at the same time. Use Vitamin C in the morning and BP in the evening.'
  },
  {
    ingredientA: 'Vitamin C',
    ...
    reason: 'In high concentrations they can reduce each other\'s effectiveness and cause flushing. Modern formulations are often fine together, but if you notice redness, apply at different times.'
  },
  {
    ...
    reason: 'Double exfoliation can damage the skin barrier, leading to dryness, redness, and increased sensitivity. Alternate between them on different days.'
  },
  {
    ingredientA: 'AHA (Glycolic, Lactic)',
    ingredientB: 'Benzoyl Peroxide',
    ...
    reason: 'Both can be drying and irritating. Using them together increases risk of over-drying and damaging your skin barrier. Use on alternate days.'
  },
  {
    ...
    reason: 'Both target acne but together they cause excessive dryness. Some dermatologists recommend alternating — BHA in the morning, BP at night, or on different days.'
  },
  {
    ...
    reason: 'Acids can break down peptide bonds, reducing their anti-aging benefits. Apply peptides first, let absorb, or use at different times of day.'
  },
  {
    ingredientA: 'Peptides',
    ingredientB: 'BHA (Salicylic Acid)',
    ...
    reason: 'The acidic pH of BHA can degrade peptides. Use BHA first and wait 20 minutes, or use them at different times of day.'
  },
];
...
export function detectConflicts(products: Array<{ id: string; name: string; brand: string }>): DetectedConflict[] {
